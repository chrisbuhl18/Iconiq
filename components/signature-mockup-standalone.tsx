...
interface SignatureMockupStandaloneProps {
  className?: string
}

export default function SignatureMockupStandalone({ className }: SignatureMockupStandaloneProps) {
  // Utility function to conditionally join class names
  const cnUtil = (...classes: (string | boolean | undefined)[]) => {

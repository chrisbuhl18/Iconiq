...
import AvatarWithLottie from "./avatar-with-lottie"

interface AvatarMockupWithLottieProps {
  className?: string
  lottiePath: string
}

export default function AvatarMockupWithLottie({
  className,
  lottiePath = "/animations/avatar-animation.json",
}: AvatarMockupWithLottieProps) {
  return (
        ...
        <div className="w-full h-full bg-white rounded-[32px] overflow-hidden relative">
          ...
          <div className="p-4">
            ...
            <div className="space-y-4">
              {/* Email with Lottie avatar */}
              <div className="border-b pb-4">
                <div className="flex items-start">
                  <div className="mr-3 flex-shrink-0">
                    <AvatarWithLottie lottiePath={lottiePath} size="sm" />
                  </div>

...
import GifAvatar from "./gif-avatar"

interface AvatarMockupWithGifProps {
  className?: string
  gifSrc: string
}

export default function AvatarMockupWithGif({ className, gifSrc = "/avatar-animation.gif" }: AvatarMockupWithGifProps) {
  return (
        ...
        <div className="w-full h-full bg-white rounded-[32px] overflow-hidden relative">
          ...
          <div className="p-4">
            ...
            <div className="space-y-4">
              {/* Email with GIF avatar */}
              <div className="border-b pb-4">
                <div className="flex items-start">
                  <div className="mr-3 flex-shrink-0">
                    <GifAvatar src={gifSrc} alt="Animated avatar" size="sm" />
                  </div>

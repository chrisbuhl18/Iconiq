...
export default function SignaturesPage() {
  const signatureFaqs = [
    ...
    },
    {
      ...
      answer:
        "Yes! Your customized portal lets you add employees as needed, all using your branded logo animation. If you’d like us to integrate each new employee’s headshot into the animation, there’s a one‑time $50 fee per user.",
    },
  ]
